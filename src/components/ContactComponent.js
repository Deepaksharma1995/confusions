...
class Contact extends Component {
  ...
  handleInputChange(event) {
    ...
    this.setState({
      [name]: value,         //for this refer to javascript.info objects
    });
  }
  ...
  handleBlur = (field) => (evt) => {      //currying function code in react is very important see Stackoverflow for more details
    this.setState({
  ...
  validate(firstname, lastname, telnum, email) {
    ...
    if (this.state.touched.firstname && firstname.length <= 3) {
      ...
      errors.firstname = 'First anme should be less than 10 characters';
    }
    ...
    if (this.state.touched.telnum && !reg.test(telnum)) {
      errors.telnum = 'Tel. number should only contain telephone numbers';
    }
